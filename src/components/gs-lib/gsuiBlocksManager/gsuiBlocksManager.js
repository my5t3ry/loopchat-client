"use strict";
import './gsuiBlocksManager.css';
import gsuiPanels from '../gsuiPanels/gsuiPanels' ;
import gsuiTimeline from '../gsuiTimeline/gsuiTimeline' ;
import gsuiBeatlines from '../gsuiBeatlines/gsuiBeatlines' ;
class gsuiBlocksManager {
    ...
    block_selected(el, v) {
        el.classList.toggle("gsuiBlocksManager-block-selected", !!v);
    }

    block_deleted(el, v) {
        el.classList.toggle("gsuiBlocksManager-block-hidden", !!v);
    }
...
export {gsuiBlocksManager as default}