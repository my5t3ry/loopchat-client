...
class gsuiPianoroll extends gsuiBlocksManager {
    ...
    block_pan(el, val) {
        this.block_sliderUpdate("pan", el, val);
    }

    block_gain(el, val) {
        this.block_sliderUpdate("gain", el, val);
    }
    ...
    _loop(a, b) {
        this._uiSliderGroup.loop(a, b);
    }

    _currentTime(beat) {
        this._uiSliderGroup.currentTime(beat);
    }
