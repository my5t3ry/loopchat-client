      ...
      <div className="gstemplates">
          <div id="loading">
              <div id="loadingContent">
                  <div id="loadingTitle">
                      <div id="loadingTitleLight">GridSound</div>
                      <div id="loadingTitleDark">GridSound</div>
                  </div>
          ...
          <div className="gsuiMixer" id="gsuiMixer-template">
              ...
              <div className="gsuiMixer-panEffects">

              </div>
          </div>

          <div className="gsuiMixerChannel" id="gsuiMixerChannel-template">
              <div className="gsuiMixerChannel-ctrl gsuiMixerChannel-nameWrap">
                  <span className="gsuiMixerChannel-name"></span>
              </div>
          ...
          <div id="gsuiPianoroll-template" className="gsuiBlocksManager gsuiPianoroll gsuiPanels-x" tabIndex="-1">
              <div className="gsuiBlocksManager-sidePanel gsuiPanels-y">
                  ...
                  <div className="gsuiPianoroll-sidePanelBottom">
                      <select className="gsuiPianoroll-slidersSelect gsui-opacityHover">
          ...
          <div id="gsuiOscillator-template" className="gsuiOscillator">
              ...
              <div className="gsuiOscillator-attr gsuiOscillator-type">
                  ...
                  <div className="gsuiOscillator-typeCtrl">
                      <a className="gsuiOscillator-typeLink gsuiOscillator-typePrev" title="Previous wave"></a>
                      <a className="gsuiOscillator-typeLink gsuiOscillator-typeNext" title="Next wave"></a>
                      <select>
              ...
              <a className="gsuiOscillator-remove" title="Remove the oscillator"></a>
          </div>
          <div id="gsuiSynthesizer-template" className="gsuiSynthesizer">
              <span className="gsuiSynthesizer-title">oscillators</span>
              ...
              <a className="gsuiSynthesizer-newOsc"></a>
          </div>
          <div id="gsuiPopup">
              <div id="gsuipp-window" tabIndex="0">
                  ...
                  <form id="gsuipp-body">
                      ...
                      <div id="gsuipp-btns">
                          <input type="button" id="gsuipp-inpCancel" value="Cancel"/>
                          <input type="submit" id="gsuipp-inpOk" value="Ok"/>
                      </div>
                  </form>
              </div>
          </div>
          <div id="gsuiSlider-template" className="gsuiSlider">
              <input type="range"/>
          ...
          <div id="gsuiSliderGroup-template" className="gsuiSliderGroup">
              <div className="gsuiSliderGroup-scale">
                  <span></span>
                  <span></span>
                  <span></span>
              </div>
          ...
          <div id="gsuiTrack-template" className="gsuiTrack">
              ...
              <div className="gsuiTrack-nameWrap">
                  <input className="gsuiTrack-name" type="text" spellCheck="false"/>
              </div>
